      ...
      {view === 'home' && (
        <div className="max-w-5xl mx-auto mb-10">
          <div className="bg-[#003262] rounded-2xl p-6 sm:p-10 md:p-14 text-center shadow-lg relative overflow-hidden border-b-4 border-[#FDB515]">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-3 relative z-10 font-serif tracking-tight leading-[1.5] [&>br]:hidden sm:[&>br]:inline">{t.heroTitle}</h2>
          </div>
